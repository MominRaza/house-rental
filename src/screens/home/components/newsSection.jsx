...
class NewsSection extends Component {
  state = {
    news: [
      {
        id: 1,
        title: "Housing subsidy scheme for middle-income families extended till March 2021",
        details:
      ...
      {
        id: 2,
        title: "Banks not passing lower rate benefits to borrowers, developers: Credai to RBI",
        details:
